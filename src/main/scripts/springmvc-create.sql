...
--user role
	INSERT INTO public.user_role( userrolename) VALUES ('admin');
	INSERT INTO public.user_role( userrolename) VALUES ('student');
	INSERT INTO public.user_role( userrolename) VALUES ('staff');
	
	
	
	--users
	INSERT INTO users( emailid, firstname, lastname, password, role_userroleid) VALUES ('admin@localhost.localdomain', 'admin', 'admin', 'abcd','1');
	INSERT INTO users( emailid, firstname, lastname, password, role_userroleid) VALUES ( 'student1@localhost.localdomain', 'student1', 'student1', 'abcd','2');
	INSERT INTO users( emailid, firstname, lastname, password, role_userroleid) VALUES ( 'student2@localhost.localdomain', 'student2', 'student2', 'abcd','2');	
	INSERT INTO users( emailid, firstname, lastname, password, role_userroleid) VALUES ('staff1@localhost.localdomain', 'staff1', 'staff1', 'abcd','3');
	INSERT INTO users( emailid, firstname, lastname, password, role_userroleid) VALUES ('staff2@localhost.localdomain', 'staff2', 'staff2', 'abcd','3');
	
	--department 
	 INSERT INTO Department (dpmtName) VALUES ('Accounting Department');
    INSERT INTO Department (dpmtName) VALUES ('Computer Science Department');
	
	--program
	INSERT INTO programs (programname, requirement, department_dpmtid) VALUES ('MS in Computer Science' ,'', 2);
	INSERT INTO programs (programname, requirement, department_dpmtid) VALUES ('MS in Accounting' ,'', 1);
	
	--addtional requirements
	INSERT INTO public.additionalreq(add_info_name, required, type, dept_dpmtid) VALUES ('GMAT', true, 'text', 1);
	
	--application status
	
	INSERT INTO public.application_status (statusname) VALUES ('New');
	INSERT INTO public.application_status (statusname) VALUES ('Pending Review');
	INSERT INTO public.application_status (statusname) VALUES ('Denied');
	INSERT INTO public.application_status (statusname) VALUES ('Recommend Admit');
	INSERT INTO public.application_status (statusname) VALUES ('Recommend Admit w/ Condition');
	INSERT INTO public.application_status (statusname) VALUES ('Saved');